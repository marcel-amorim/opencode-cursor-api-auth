...
export function parseCursorStreamFallbackLine(line) {
    if (!line || typeof line !== "string") {
        return null;
    }
    try {
...
export function mergeAssistantContent(current, incoming) {
    if (!incoming) {
...
export function sanitizeThinkingText(text, inFence, inPlanJson) {
    if (!text) {
