...
export async function syncCursorModels(workspaceDirectory: string, config: CursorPluginConfig): Promise<ModelSyncResult> {
...
export function buildRuntimeProviderModels(
